  ...
  return (
    <div className="min-h-screen flex bg-white">
      ...
      <aside className="fixed left-0 top-0 bottom-0 w-[260px] bg-white border-r border-gray-100 flex flex-col z-30">
        ...
        <div className="px-6 py-5 border-b border-gray-100">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-bold text-gray-900">TruckManager</h1>
        ...
        <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
          {menuItems.map((item) => {
            ...
            return (
              ...
              >
                <span className={cn(isActive ? "text-sky-500" : "text-gray-400")}>
                  {item.icon}
                </span>
                {item.label}
              </Link>
        ...
        <div className="px-4 py-4 border-t border-gray-100">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-sky-100 text-sky-600 flex items-center justify-center text-sm font-semibold">
      ...
      <div className="flex-1 ml-[260px]">
        ...
        {/* Page content */}
        <main className="p-6 bg-[#F8FAFC] min-h-[calc(100vh-73px)]">
