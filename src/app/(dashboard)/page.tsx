...
export default function DashboardPage() {
  ...
  const [alertsCount, setAlertsCount] = useState({ critique: 0, haute: 0, total: 0 });
  ...
  useEffect(() => {
    fetch("/api/alertes")
      ...
      .then((d) => {
        setAlerts(d.alerts || []);
        setAlertsCount({ critique: d.totalCritique || 0, haute: d.totalHaute || 0, total: d.total || 0 });
      })
      .catch(() => {});
  }, []);
