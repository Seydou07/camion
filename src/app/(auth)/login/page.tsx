      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-6 sm:p-8 lg:p-12 relative bg-gradient-to-br from-white via-slate-50/60 to-white overflow-hidden">
        ...
        <div className="w-full max-w-sm relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* Error Banner */}
            {error && (
              <div className="flex items-start gap-2.5 px-4 py-3 rounded-xl bg-rose-50 border border-rose-100 text-rose-700 text-xs font-semibold animate-fade-in shadow-sm">
