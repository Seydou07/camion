  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row overflow-hidden relative bg-[#F8FAFC] font-sans">
      ...
      <div className="hidden md:flex md:w-1/2 relative overflow-hidden flex-col justify-between p-12 lg:p-20">
        ...
        <div className="relative z-10 flex items-center gap-3 self-start">
          ...
          <span className="text-xl font-bold tracking-tight text-white">
            Truck<span className="text-sky-400">Manager</span>
          </span>
        </div>

        {/* Hero Middle Description */}
        <div className="relative z-10 max-w-xl my-auto pt-20">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-sky-500/20 border border-sky-400/30 text-sky-300 text-xs font-bold uppercase tracking-wider mb-6">
            <span className="w-1.5 h-1.5 rounded-full bg-sky-400" />
            Portail Entreprise v2.0
          </div>
          <h1 className="text-4xl lg:text-5xl font-black text-white leading-tight tracking-tight">
            La performance au cœur de votre <span className="text-sky-400">logistique</span>.
          </h1>
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-6 sm:p-12 lg:p-16 relative bg-white border-l border-slate-100">
        ...
        {/* Soft elegant glows */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-64 h-64 bg-sky-100/50 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="w-full max-w-sm relative z-10 animate-fade-in-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  required
                  className="w-full bg-[#F8FAFC] border border-slate-200 text-slate-800 placeholder:text-slate-400 pl-11 pr-4 py-3 rounded-2xl text-sm transition-all duration-300 focus:outline-none focus:border-sky-500 focus:ring-4 focus:ring-sky-500/10 hover:border-slate-300"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-sky-500 hover:text-sky-600 font-bold hover:underline cursor-pointer transition-colors">
                  Mot de passe oublié ?
                </span>
              </div>
              <div className="relative group">
                ...
                <input
                  ...
                  required
                  className="w-full bg-[#F8FAFC] border border-slate-200 text-slate-800 placeholder:text-slate-400 pl-11 pr-10 py-3 rounded-2xl text-sm transition-all duration-300 focus:outline-none focus:border-sky-500 focus:ring-4 focus:ring-sky-500/10 hover:border-slate-300"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full relative py-3.5 px-4 bg-sky-500 hover:bg-sky-600 disabled:bg-sky-500/50 text-white rounded-2xl text-sm font-bold tracking-wide shadow-lg shadow-sky-500/15 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-sky-500/20 active:scale-[0.98] disabled:cursor-not-allowed flex items-center justify-center overflow-hidden group btn-premium cursor-pointer"
            >
              {loading ? (
          ...
          <div className="mt-8 pt-6 border-t border-slate-100 text-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 bg-slate-50 hover:bg-slate-100 text-sky-600 hover:text-sky-700 border border-slate-100 hover:border-slate-200 rounded-2xl text-xs font-bold tracking-wide transition-all duration-200 active:scale-95 cursor-pointer shadow-sm"
            >
